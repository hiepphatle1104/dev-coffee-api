...
type GetItemListStorage interface {
	GetItems(ctx context.Context, paging *common.Paging) (*[]itemmodel.Item, error)
}
...
func (s *GetItemListService) GetItemList(ctx context.Context, paging *common.Paging) (*[]itemmodel.Item, error) {
